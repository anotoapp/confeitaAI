...
async function handleSetupSubmit(e) {
    ...
    try {
        ...
        if (err.message && err.message.includes("Database error saving new user")) {
            return showSetupError("Erro no banco de dados ao salvar usuário. Certifique-se de que a migração de WhatsApp ('migration_usuario_phone.sql') foi executada no Supabase.");
        }
